    ...
    <v-col cols="12" sm="10" md="8">
      ...
      <div class="section">
        ...
        <p>
          ...
          <v-img src="@/assets/SeoulHackathon/team.jpg"/>
      ...
      <div class="section">
        ...
        <p>Technologie-wise, we decided to go for <b>React</b> on the front as all the devs expect Suzie had experience
          ...
          We had to host our project somewhere judge could see it, so I decided to start with that devops part, so then we
          would just have to worry about development.<br/>
          This part was the one I was less sure about, for the front I already hosted sites on S3 so I was confident with that.
